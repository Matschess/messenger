...
<div id="loginbox" class="loginboxPre">
    ...
    <div id="loginboxContent">
        <div id="loginboxContentMargin">
            ...
            <i id="emailFalse" class="material-icons icon_check tooltip"
               title="Die Email-Adresse wurde bereits verwendet oder entspricht nicht dem vorgegebenen Format.">clear</i>
            <br/>
            ...
            <br/>
            <input id="username" class="loginTextboxLong" type="text" placeholder="Benutzername (mind. 6 Zeichen)"
                   title="Benutzername"/>
            <i id="usernameTrue" class="material-icons">done</i>
            <i id="usernameFalse" class="material-icons tooltip"
               title="Der Benutzername ist vergeben, ungültig oder kürzer als 6 Zeichen.">clear</i>
            <br/>
            ...
            <i id="passwordFalse" class="material-icons icon_check tooltip"
               title="Das Passwort ist zu unsicher">clear</i>
            <br/>
            <div id="passwordSafety">
                <div id="passwordSafetyStatus"></div>
            </div>
            ...
            <i id="passwordCheckFalse" class="material-icons icon_check tooltip"
               title="Die Passwörter stimmen nicht überein">clear</i>
            <br/>
            <br/>
            <br/>
